...
I’m an aspiring data analyst with a growing interest in how data can be used to support better decision-making in real-world environments.
...
The project will focus on data cleaning, exploratory data analysis, and clear visualisation of insights.
...
30-Day Goal:
Complete a beginner-to-intermediate Python or SQL course and apply the skills to a small dataset published on GitHub.

6-Month Goal:
Build and publish at least one complete data analysis project on my GitHub Pages portfolio, including a clear problem statement, analysis, visualisations, and written insights.
